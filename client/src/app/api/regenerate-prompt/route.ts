...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompt = `Generate a DIFFERENT version of this Veo3 video prompt with creative variations:
...
Create a fresh, alternative approach while maintaining the same core concept. Include:
1. A new complete video prompt (50-200 words)
